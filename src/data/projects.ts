...
export const resumeItems = [
  {
    ...
    highlights: [
      "관리센터 언어설정 바텀시트를 적용하고 쿠키 저장 로직을 구성했습니다.",
      "CRM 통계 페이지 공개 여부 옵션을 반영했습니다.",
      "관리자 회원 로그 검색 API를 연동했습니다.",
      "관리자 로그 엑셀 다운로드 기능을 추가했습니다.",
    ],
    outcomes: [
      "관리센터의 언어 설정 저장, CRM 통계 공개 여부 제어, 관리자 로그 검색 및 엑셀 다운로드 기능을 구현해 설정·조회·다운로드 흐름이 이어지도록 구성했습니다.",
    ],
  },
  {
    id: "dongne-flower-admin",
    ...
    outcomes: [
      "회원 검색 상태와 엑셀 다운로드 처리를 분리하고, 다운로드 기능을 버튼·훅·유틸 구조로 구성해 회원 정보 조회와 파일 다운로드 흐름을 명확히 나누었습니다.",
    ],
  },
  {
    id: "dongne-flower",
  ...
  },
  {
    ...
    outcomes: [
      "입점사가 상품 정보를 수정하고 결과를 미리 확인할 수 있도록 상품 수정 플로우와 리스트/상세 미리보기를 구현했으며, 무료견적 필터와 영업상태 API 연동을 통해 운영 화면의 주요 인터랙션을 구성했습니다.",
    ],
  },
  {
    id: "wowcruise",
    ...
    outcomes: [
      "예약 단계 화면과 객실 선택 플로우를 구성하고, 홀드 타이머 관련 세션 유지 로직과 검색 키보드 이벤트, 시니어 할인 조건 분기를 반영해 예약 과정의 선택·유지·분기 흐름이 이어지도록 구성했습니다.",
    ],
  },
  {
    id: "sidiz",
